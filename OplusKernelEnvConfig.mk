...
export CONFIG_OPPO_SECURE_GUARD=y
KBUILD_CFLAGS += -DCONFIG_OPPO_SECURE_GUARD
endif

ifeq ($(OPLUS_FEATURE_SECURE_ROOTGUARD),yes)
export CONFIG_OPPO_ROOT_CHECK=y
KBUILD_CFLAGS += -DCONFIG_OPPO_ROOT_CHECK
endif

ifeq ($(OPLUS_FEATURE_SECURE_MOUNTGUARD),yes)
export CONFIG_OPPO_MOUNT_BLOCK=y
KBUILD_CFLAGS += -DCONFIG_OPPO_MOUNT_BLOCK
endif

ifeq ($(OPLUS_FEATURE_SECURE_EXECGUARD),yes)
export CONFIG_OPPO_EXECVE_BLOCK=y
KBUILD_CFLAGS += -DCONFIG_OPPO_EXECVE_BLOCK
KBUILD_CFLAGS += -DCONFIG_OPPO_EXECVE_REPORT
endif

ifeq ($(OPLUS_FEATURE_SECURE_KEVENTUPLOAD),yes)
export CONFIG_OPPO_KEVENT_UPLOAD=y
KBUILD_CFLAGS += -DCONFIG_OPPO_KEVENT_UPLOAD
endif
